...
# Summarise for groups = parish, FT, Quality, and County
...
# join either summary stats and parish stats for R and QGIS - set to whole number - calculate difference in area and price
